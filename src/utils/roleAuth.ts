...
export const INITIAL_ROLE_AUTH_CONFIGS: Record<UserRole, RoleAuthConfig> = {
  ...
  GURU: {
    ...
    description: 'Akses terbatas hanya untuk Data Siswa Rombel, E-Raport Nilai Kurikulum Merdeka, dan Jurnal Mengajar (tanpa akses Master Guru, Pengurus Yayasan, & Supplier).',
    password: 'guru123',
